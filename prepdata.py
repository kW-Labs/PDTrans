...
def prepare(task='search_'):
    ...
    valid_data = covariates[
                 data_frame[train_start:valid_start].shape[0] - 1:data_frame[train_start:valid_end].shape[0]].copy()
    test_data = covariates[
                data_frame[train_start:test_start].shape[0] - 1:data_frame[train_start:test_end].shape[0]].copy()
